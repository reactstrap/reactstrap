      ...
      >
        ...
        >
          {({ ref, style, placement: popperPlacement, isReferenceHidden, arrowProps, update }) => (
            <div ref={ref} style={style} className={popperClassName} x-placement={popperPlacement} data-popper-placement={popperPlacement} data-popper-reference-hidden={isReferenceHidden ? 'true' : undefined}>

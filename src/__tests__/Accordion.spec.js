...
describe('Accordion', () => {
  it('should render with "accordion" class', () => {
    const wrapper = mount(
      <Accordion open="this accordion" toggle={() => {}} />,
    );
  ...
  it('should render with "accordion-flush" class', () => {
    const wrapper = mount(
      <Accordion flush open="this accordion" toggle={() => {}} />,
    );
  ...
  it('should render additional classes', () => {
    const wrapper = mount(
      <Accordion className="other" open="this accordion" toggle={() => {}} />,
    );
  ...
  it('should render custom tag', () => {
    const wrapper = mount(
      <Accordion tag="main" open="this accordion" toggle={() => {}} />,
    );
